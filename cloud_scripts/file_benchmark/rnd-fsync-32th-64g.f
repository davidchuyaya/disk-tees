...
define process name=filerandomfsync, instances=1
{
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file1, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file2, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=2
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file3, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=3
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file4, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=4
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file5, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=5
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file6, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=6
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file7, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=7
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file8, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=8
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file9, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=9
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file10, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=10
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file11, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=11
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file12, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=12
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file13, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=13
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file14, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=14
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file15, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=15
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file16, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=16
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file17, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=17
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file18, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=18
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file19, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=19
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file20, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=20
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file21, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=21
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file22, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=22
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file23, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=23
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file24, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=24
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file25, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=25
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file26, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=26
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file27, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=27
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file28, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=28
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file29, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=29
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file30, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=30
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file31, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=31
                flowop fsync name=fsync-file, fd=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file32, filesetname=bigfileset, random, iosize=$io_size,iters=$iterations, fd=1, indexed=32
                flowop fsync name=fsync-file, fd=1
