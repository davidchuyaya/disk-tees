...
define process name=filesequentialfsync, instances=1
{
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file1, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=1
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file2, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=2
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file3, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=3
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file4, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=4
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file5, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=5
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file6, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=6
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file7, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=7
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file8, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=8
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file9, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=9
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file10, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=10
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file11, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=11
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file12, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=12
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file13, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=13
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file14, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=14
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file15, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=15
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file16, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=16
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file17, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=17
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file18, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=18
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file19, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=19
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file20, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=20
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file21, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=21
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file22, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=22
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file23, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=23
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file24, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=24
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file25, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=25
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file26, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=26
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file27, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=27
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file28, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=28
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file29, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=29
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file30, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=30
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file31, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=31
        ...
        thread name=filewriter, memsize=$io_size, instances=$nthreads
        {
                ...
                flowop write name=write-file32, filesetname=bigfileset, iosize=$io_size, iters=$iterations, directio, dsync, fd=1, indexed=32
